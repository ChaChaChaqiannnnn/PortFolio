...
export default function Home(){
  ...
  return <main>
    ...
    <nav className="nav-shell"><a className="wordmark" href="#top">CQ</a><p>Creative technologist<br/>Kuala Lumpur · MY</p><div><a href="#work">Work</a><a href="#about">About</a><a href="https://github.com/ChaChaChaqiannnnn" target="_blank" rel="noreferrer">GitHub ↗</a></div></nav>
    <section className="film" id="top">
      ...
      <div className="story">
        <article className={`story-chapter hero ${activeIndex===0?"is-active":""}`} data-index="0"><p className="sup-title">An interactive film by Hong Chia Qian</p><h1><span>I build ideas</span><br/><em>you can feel.</em></h1><div className="hero-bottom"><p>Developer, artist and curious human creating expressive systems across learning technology, automation and software design.</p><a href="#work"><ArrowDown size={16}/> Begin the journey</a></div><div className="scroll-cue"><MousePointer2 size={15}/><span>Scroll to move the camera</span></div></article>
