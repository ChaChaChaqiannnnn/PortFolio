...
export default function Home(){
  ...
  return <main>
    ...
    <section className="film" id="top">
      ...
      <div className="story">
        <article className={`story-chapter hero ${activeIndex===0?"is-active":""}`} data-index="0"><p className="sup-title">An interactive portfolio by Hong Chia Qian</p><h1><span>I build ideas</span><br/><em>you can feel.</em></h1><div className="hero-bottom"><p>Software engineering student and creative developer open to internship and graduate opportunities. I build dependable digital products with thoughtful interaction, strong testing, and a distinctive visual point of view.</p><a href="#work"><ArrowDown size={16}/> View my work</a></div><div className="scroll-cue"><MousePointer2 size={15}/><span>Scroll to move the camera</span></div></article>
