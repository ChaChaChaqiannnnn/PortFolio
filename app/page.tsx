...
export default function Home(){
  ...
  return <main>
    ...
    <section className="film" id="top">
      ...
      <div className="story">
        <article className={`story-chapter hero ${activeIndex===0?"is-active":""}`} data-index="0"><p className="sup-title">An interactive film by Hong Chia Qian</p><h1><span>I build ideas</span><br/><em>you can feel.</em></h1><div className="hero-bottom"><p>Developer, artist and curious human. During my internship, I’m focused on turning thoughtful ideas into clear, dependable digital experiences—growing through product engineering, testing and creative code.</p><a href="#work"><ArrowDown size={16}/> Begin the journey</a></div><div className="scroll-cue"><MousePointer2 size={15}/><span>Scroll to move the camera</span></div></article>
